...
<div class="container">
    <div class="row justify-content-center ">
        ...
        @endif
            ...
            <form action="{{url('process-register')}}" method="post" class="card card-body shadow p-5">
            @csrf
                ...
                <div class="mb-3">
                    <label for="name" class="visually-show mb-2">Nama Lengkap</label>
                ...
                <div class="mb-3">
                    <label for="email" class="visually-show mb-2">Email address</label>
                ...
                <div class="mb-3">
                    <label for="inputPassword" class="visually-show mb-2">Password</label>
