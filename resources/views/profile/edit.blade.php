                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_telp" value="{{ $user->profile
                                            ? $user->profile->no_telp : '' }}"  class="form-control">
                                </div>
                                <div class="address mb-5">
                                    <label for="">Alamat</label>
                                    <textarea class="form-control" name="address" id="" cols="15" rows="5">{{ $user->profile
